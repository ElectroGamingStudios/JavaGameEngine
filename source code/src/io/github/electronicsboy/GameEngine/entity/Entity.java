...
public abstract class Entity {
	...
	public Entity(int width, int height, int x, int y, EntityType type, Color col, MovementType movementType, BufferedImage texture) {
		this.height = height;
		this.width = width;
		this.type = type;
		this.col = col;
	...
	public void move() {
		...
		if(movementType != MovementType.Bounce) {
			x = Util.ClampUtil.clamp(x, 0, (Util.WIDTH-(width+15)));
			y = Util.ClampUtil.clamp(y, 0, (Util.HEIGHT-(height+40)));
		}
	}
